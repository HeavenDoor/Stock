...
namespace StockSync
{
    ...
    {
        public Stockitem_Changerate_Fluctuaterate(TEMP_Stockitem_Changerate_Fluctuaterate tmp)
        {
    ...
    /// <summary>
    /// Stockitem_Changerate_Fluctuaterate 过渡类
    /// </summary>


    public class TEMP_Stockitem_Changerate_Fluctuaterate
    {
        /// <summary>
        /// 股票代码 
        /// </summary>
