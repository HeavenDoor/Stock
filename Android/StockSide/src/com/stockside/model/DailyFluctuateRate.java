...
@Table(name = "DailyFluctuateRate")
public class DailyFluctuateRate
{
	@Id(column = "StockCode")
	...
	public static DailyFluctuateRate ConvertTo(StockItemEntity.StockItemResult.StockItem item)
	{
		DailyFluctuateRate rate = new DailyFluctuateRate();
