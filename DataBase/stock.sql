...
SELECT * FROM STOCKITEM_CHANGERATE_FLUCTUATERATE
...
DELETE FROM STOCKITEM_DAILYFLUCTUATERATE;
DELETE FROM STOCKITEM_DAILYCHANGERATE;
DELETE FROM STOCKITEM_CHANGERATE_FLUCTUATERATE;
DELETE FROM LASTUPDATE
  
DROP TABLE STOCKITEM_DAILYFLUCTUATERATE;
DROP TABLE STOCKITEM_DAILYCHANGERATE;
DROP TABLE  STOCKITEM_CHANGERATE_FLUCTUATERATE
  
  SELECT * FROM STOCKITEM WHERE STOCKCODE='601099'
 UPDATE STOCKITEM SET STOCKDATE='2015/03/25 14:12:09' WHERE STOCKDATE='2015/03/25 13:31:54' AND STOCKCODE='601099'

UPDATE STOCKITEM SET STOCKDATE='2015/3/25 14:12:9', STOCKCODE='601090' STOCKNAME='太平洋' , OPENPRICE=13.5 , CLOSEPRICE=13.61 , HIGHESTPRICE=13.8 , LOWESTPRICE=13.34 , FLUCTUATEMOUNT=0.14 , FLUCTUATERATE=1.04 , CHANGERATE=5.52 , TRADEVOLUME=1369243 , TRADEMOUNT=186389 , TOATLMARKETCAP=480.5 , CIRCULATIONMARKETCAP=337.59 , ISSTOPPED=FALSE  WHERE STOCKDATE='2015/3/25 13:31:54' AND STOCKCODE='601099'
----------------------------------------------------------------------------------------------------------------
SELECT CONVERT(CHAR(10),'STOCKDATE',120) FROM STOCKITEM

SELECT CONVERT(DATETIME,CONVERT(CHAR(08),"STOCKDATE",112)) FROM STOCKITEM


SELECT CONVERT(CHAR(10),'2012-03-24 11:31:00',111)FROM STOCKITEM

SELECT * FROM stockitem WHERE STOCKCODE = '603020' AND (DATE(STOCKDATE)='2015-03-25')
  
  DELETE FROM stockitem WHERE (DATE(STOCKDATE)='2015-03-25')
  
  UPDATE stockitem SET ISSTOPPED=TRUE WHERE OPENPRICE=0
  
  SELECT * FROM STOCKITEM_DAILYFLUCTUATERATE
---------------------------------------------------------------------------------------------------------------  
...
--drop TABLE USER
DELETE FROM USER
INSERT INTO USER VALUES('766058573@qq.com', 'shenghai', '123465','test', '55', '2015/03/25 13:31:54')
...
CREATE TABLE LASTUPDATE(
  ...
  INSERT INTO lastupdate VALUES('2014-9-24')
...
INSERT INTO HOLIDAYS VALUES('2014-10-4'),('2014-10-5'),('2014-10-6'),('2014-10-7'),('2015-1-1'),('2015-1-2'),('2015-2-18'),('2015-2-19');
INSERT INTO HOLIDAYS VALUES('2015-2-20'),('2015-2-23'),('2015-2-24'),('2015-4-6'),('2015-5-1'),('2015-6-22')
...
DELETE FROM TRADEDATE WHERE STOCKTRADEDATE='2014/9/25'
...
SELECT * FROM STOCKITEM_CHANGERATE_FLUCTUATERATE  WHERE TRADEDAYS=2 AND CHANGERATEMAIN=TRUE ORDER BY CHANGERATE DESC
...
SELECT B.STOCKCODE, B.STOCKNAME,(SELECT S.CLOSEPRICE FROM STOCKITEM S WHERE S.STOCKDATE='2014/9/24' AND S.STOCKCODE=B.STOCKCODE) AS CLOSEPRICE,SUM(CHANGERATE) AS CHANGERATE, SUM(FLUCTUATERATE) AS FLUCTUATERATE FROM STOCKITEM B WHERE B.STOCKDATE >='2014-9-13' GROUP BY B.STOCKCODE ORDER BY FLUCTUATERATE ASC LIMIT 0,15
...
SELECT STOCKCODE FROM  stockitem WHERE stockdate="2014/9/24";

 SELECT * FROM stock WHERE stockcode NOT IN (SELECT STOCKCODE FROM  stockitem WHERE stockdate="2014/09/26")
 SELECT * FROM STOCK WHERE STOCKCODE NOT IN (SELECT STOCKCODE FROM  STOCKITEM WHERE STOCKDATE='2014/09/26')
 
 SELECT * FROM stockitem WHERE stockcode="002462"
...
(DATE(STOCKDATE)='2015-03-25')

SELECT B.STOCKCODE, B.STOCKNAME,(SELECT S.CLOSEPRICE FROM STOCKITEM S WHERE S.STOCKDATE='2014-8-8' AND S.STOCKCODE=B.STOCKCODE) AS CLOSEPRICE,SUM(CHANGERATE) AS CHANGERATE, SUM(FLUCTUATERATE) AS FLUCTUATERATE FROM STOCKITEM B WHERE B.STOCKDATE >='2014-8-7' GROUP BY B.STOCKCODE ORDER BY FLUCTUATERATE DESC LIMIT 0,15

SELECT B.STOCKCODE, B.STOCKNAME,SUM(CHANGERATE) AS CHANGERATE, SUM(FLUCTUATERATE) AS FLUCTUATERATE FROM STOCKITEM B WHERE B.STOCKDATE >='2014-8-6' GROUP BY B.STOCKCODE ORDER BY FLUCTUATERATE DESC LIMIT 0,15

SELECT B.STOCKCODE, B.STOCKNAME,(SELECT S.CLOSEPRICE FROM STOCKITEM S WHERE S.STOCKDATE='{0}' AND S.STOCKCODE=B.STOCKCODE) AS CLOSEPRICE,SUM(CHANGERATE) AS CHANGERATE, SUM(FLUCTUATERATE) AS FLUCTUATERATE FROM STOCKITEM B WHERE B.STOCKDATE >='{1}' GROUP BY B.STOCKCODE ORDER BY CHANGERATE DESC LIMIT 0,{2}", recentDay, destDay, ItemCount * 2);

SELECT B.STOCKCODE, B.STOCKNAME,(SELECT S.CLOSEPRICE FROM STOCKITEM S WHERE S.STOCKDATE='2014/9/25' AND S.STOCKCODE=B.STOCKCODE) AS CLOSEPRICE,SUM(CHANGERATE) AS CHANGERATE, SUM(FLUCTUATERATE) AS FLUCTUATERATE FROM STOCKITEM B WHERE B.STOCKDATE >='2014/9/24' GROUP BY B.STOCKCODE ORDER BY CHANGERATE DESC LIMIT 0,30

SELECT * FROM STOCKITEM_CHANGERATE_FLUCTUATERATE WHERE CLOSEPRICE=0

SELECT * FROM STOCKITEM WHERE STOCKCODE='002067' ORDER BY stockdate DESC