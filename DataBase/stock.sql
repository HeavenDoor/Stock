...
SELECT STOCKCODE FROM  stockitem WHERE stockdate="2014/9/24";
 ...
 SELECT * FROM stock WHERE stockcode NOT IN (SELECT STOCKCODE FROM  stockitem WHERE stockdate="2014/9/24")
...
SELECT * FROM stock WHERE stockcode NOT IN (SELECT STOCKCODE FROM stockitem WHERE stockdate="2014/09/25")



SELECT B.STOCKCODE, B.STOCKNAME,(SELECT S.CLOSEPRICE FROM STOCKITEM S WHERE S.STOCKDATE='2014/9/24' AND S.STOCKCODE=B.STOCKCODE) AS CLOSEPRICE,SUM(CHANGERATE) AS CHANGERATE, SUM(FLUCTUATERATE) AS FLUCTUATERATE FROM STOCKITEM B WHERE B.STOCKDATE >='2014/9/3' GROUP BY B.STOCKCODE ORDER BY FLUCTUATERATE DESC LIMIT 0,15
